...
def get_fh():
    files = [
        ...
        '/Users/ploskon/Dropbox/ALICE/Upgrade/NestorNLO/Xiaoming/2nd/pyxsect/Tune4Cx/outputs/AnalysisOutputs_InclPt.root',
        ...
        #'/Users/ploskon/Dropbox/ALICE/Upgrade/NestorNLO/fromMarkus/New/Jetcrosssection.root'
        '/Users/ploskon/Dropbox/ALICE/Upgrade/NestorNLO/fromMarkus/New/Ratio-totalError.root',
        '/Users/ploskon/Dropbox/ALICE/Upgrade/NestorNLO/fromMarkus/New2/grassymerr.root'
        ]
...
def main():
    ...
    #ratio.add_from_file(fhs[0][3], fhs[1][3],
    #                    'Jets NLO N. Armesto Priv. Comm. w/ uncert.',
    #                    'L P +l1')
        
    ratio.add_from_file(fhs[0][1], fhs[1][1], 'Prompt D-meson by FONLL, |#eta| < 0.5 ', '+l1 +k6')
