...
//=========  (Tue Sep 15 09:04:59 2015) by ROOT version5.34/08
   ...
   hDum__1__1->GetXaxis()->SetTitle("#LTd#it{N}_{ch}/d#it{#eta}#GT_{|#it{#eta}|< 0.5}");
   ...
   greAA1->SetMarkerSize(2);
   greAA1->SetMarkerStyle(20);
   greAA1->SetPoint(0,55.5 / TMath::Sqrt(22.52 / npscale) * escale,0.004440333);
   greAA1->SetPointError(0,3 / TMath::Sqrt(22.52 / npscale) * escale,0.0001110083);
   greAA1->SetPoint(1,205 / TMath::Sqrt(68.56 / npscale) * escale,0.005501285);
   greAA1->SetPointError(1,7.5 / TMath::Sqrt(68.56 / npscale) * escale,5.141388e-05);
   greAA1->SetPoint(2,537.5 / TMath::Sqrt(157.2 / npscale) * escale,0.005976331);
   greAA1->SetPointError(2,19 / TMath::Sqrt(257.2 / npscale) * escale,5.91716e-05);
   greAA1->SetPoint(3,966 / TMath::Sqrt(260.1 / npscale) * escale,0.005660793);
   greAA1->SetPointError(3,37 / TMath::Sqrt(260.1 / npscale) * escale,6.60793e-05);
   greAA1->SetPoint(4,1447.5 / TMath::Sqrt(355. / npscale) * escale,0.004986916);
   greAA1->SetPointError(4,54.5 / TMath::Sqrt(355. / npscale) * escale,5.981308e-05);
   ...
   gre_pA1->SetMarkerStyle(34);
   gre_pA1->SetPoint(0,45.15/ TMath::Sqrt(15.70 / npscale) * escale,0.005768621);
   gre_pA1->SetPoint(1,36.22/ TMath::Sqrt(14.00 / npscale) * escale,0.005622045);
   gre_pA1->SetPoint(2,30.46/ TMath::Sqrt(12.70 / npscale) * escale,0.005346414);
   gre_pA1->SetPoint(3,23.24/ TMath::Sqrt(10.40 / npscale) * escale,0.005057942);
   gre_pA1->SetPoint(4,16.08/ TMath::Sqrt( 7.42 / npscale) * escale,0.0047482);
   gre_pA1->SetPoint(5,9.82 / TMath::Sqrt( 4.81 / npscale) * escale,0.004207201);
   gre_pA1->SetPoint(6,4.41 / TMath::Sqrt( 2.94 / npscale) * escale,0.003419286);
