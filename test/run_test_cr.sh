...
time fastsim -nev $nev -config ../config/pythia_multiple_coll_cr.cmnd -out cr.root
time fastsim -nev $nev -config ../config/pythia_multiple_coll_NOcr.cmnd -out NOcr.root
